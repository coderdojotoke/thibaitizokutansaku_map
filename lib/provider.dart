...
class ChibaujiListNotifier extends StateNotifier<List<ChibaUji>> {
  ChibaujiListNotifier() : super([
    ...
    ChibaUji(no: 4, name: '通町公園',subtitle:'千葉常胤像とこんにちは！', image: 'toorimati2.jpg', favorite: false,lat: 35.610867,lng: 140.122540,flag: false),
    ...
    ChibaUji(no: 9, name: '君待橋の碑',subtitle:'小さい公園になっているよ！日陰で休んでみる？', image: 'kimimatibasinohi.jpg', favorite: false,lat: 35.601338236815,lng: 140.119213819469,flag: false),
    ...
    ChibaUji(no: 12, name: '智光院',subtitle:'亥鼻城の緑が見えてきれい！駐車場の奥にあるよ！', image: 'tikouinn.jpg', favorite: false,lat: 35.6042664767976,lng: 140.125921218011,flag: false),
